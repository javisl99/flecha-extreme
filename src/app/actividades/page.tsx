  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <h1 className="text-xl sm:text-2xl font-bold text-primary-dark dark:text-primary-light">Actividades</h1>
                  ...
                  {reservasFiltradas.map((reserva) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          <span className="text-gray-500 dark:text-gray-400 text-xs">Horario:</span>
                        ...
                        <div>
                          <span className="text-gray-500 dark:text-gray-400 text-xs">Cantidad:</span>
                      ...
                      <div className="flex justify-end space-x-2 mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                        <button 
                          className="p-2 rounded-full text-primary-dark dark:text-primary-light bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 cursor-pointer" 
                          title="Ver"
                          onClick={(e) => {
                            e.stopPropagation();
                            handleVerReserva(reserva);
                        ...
                        {(reserva.ticket_url || reserva.ticket_url_reserva) && (
                          <button 
                            className="p-2 rounded-full text-blue-600 dark:text-blue-500 bg-blue-100 dark:bg-blue-900 hover:bg-blue-200 dark:hover:bg-blue-800 cursor-pointer" 
                            title="Descargar ticket"
                            onClick={(e) => handleDescargarTicket(reserva, e)}
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button 
                          className="p-2 rounded-full text-red-600 dark:text-red-500 bg-red-100 dark:bg-red-900 hover:bg-red-200 dark:hover:bg-red-800 cursor-pointer" 
                          title="Eliminar"
                          onClick={(e) => {
                            e.stopPropagation();
                            handleEliminarReserva(reserva);
