  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className={`inline-flex min-h-11 items-center gap-3 rounded-full border px-4 py-2.5 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-primary/15 ${
          isOpen
      ...
      {isOpen ? (
        <div className="absolute right-0 top-full z-30 mt-3 w-[min(92vw,44rem)] rounded-[1.25rem] border border-outline-variant/20 bg-white p-4 shadow-[0_22px_50px_rgba(15,23,42,0.14)] sm:p-5">
