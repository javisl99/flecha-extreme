...
export function FiltrosEmpleados({ onFiltrosChange }: FiltrosEmpleadosProps) {
  ...
  const limpiarFiltros = () => {
    const filtrosVacios: FiltrosEmpleadoState = {
      nombre: '',
      apellidos: '',
      email: '',
      movil: '',
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-700">
      ...
      >
        <h3 className="font-medium text-lg text-gray-900 dark:text-white">Filtros</h3>
      ...
      <div className="px-4 py-2 flex flex-wrap gap-2 border-t border-gray-200 dark:border-gray-700">
        {filtros.nombre && (
