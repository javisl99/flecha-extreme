									...
									<div class="tab-content">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
														<label class="control-label">
															<?php echo esc_attr( $gm_image_browser_layout_opacity_title ); ?> :
															<span class="required" aria-required="true">* ( <?php echo esc_attr( $gm_premium_edition ); ?> )</span>
														</label>
														<div class="input-icon right">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="input-icon right">
															...
															<input type="text" class="form-control input-normal input-inline" name="ux_txt_border_style_image[]" id="ux_txt_border_style_color_image" onblur="default_value_gallery_master('#ux_txt_border_style_color_image', '#000000')" onfocus="color_picker_gallery_master(this, this.value)" placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $image_browser_layout_general_border_style[2] ); ?>">
														</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-icon right">
														<input type="text" class="form-control" name="ux_txt_shadow_color_image" id="ux_txt_shadow_color_image" onblur="default_value_gallery_master('#ux_txt_shadow_color_image', '#000000')" placeholder="<?php echo esc_attr( $gm_shadow_color ); ?>" onfocus="color_picker_gallery_master(this, this.value)"  value="<?php echo isset( $image_browser_layout_data['image_browser_layout_general_shadow_color'] ) ? esc_attr( $image_browser_layout_data['image_browser_layout_general_shadow_color'] ) : '#000000'; ?>">
													</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-icon right">
														<input type="text" class="form-control" name="ux_txt_button_color" id="ux_txt_button_color" onblur="default_value_gallery_master('#ux_txt_button_color', '#000000')" placeholder="<?php echo esc_attr( $gm_image_browser_layout_buttons_color_tooltip ); ?>"  onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset( $image_browser_layout_data['image_browser_layout_general_buttons_color'] ) ? esc_attr( $image_browser_layout_data['image_browser_layout_general_buttons_color'] ) : '#000000'; ?>">
													</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="ux_txt_button_hover_color" id="ux_txt_button_hover_color" onblur="default_value_gallery_master('#ux_txt_button_hover_color', '#105278')" placeholder="<?php echo esc_attr( $gm_buttons_hover_color_title ); ?>" onfocus="color_picker_gallery_master(this, this.value)"  value="<?php echo isset( $image_browser_layout_data['image_browser_layout_general_buttons_hover_color'] ) ? esc_attr( $image_browser_layout_data['image_browser_layout_general_buttons_hover_color'] ) : '#105278'; ?>">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-icon right">
														<input type="text" class="form-control input-width-25 input-inline" name="ux_txt_buttons_border_style[]" id="ux_txt_buttons_border_style_width" placeholder="<?php echo esc_attr( $gm_width_placeholder ); ?>" onblur="default_value_gallery_master('#ux_txt_buttons_border_style_width', 0);" value="<?php echo intval( $image_browser_layout_general_buttons_border_style[0] ); ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);">
														...
														<input type="text" class="form-control input-normal input-inline" name="ux_txt_buttons_border_style[]" id="ux_txt_buttons_border_style_color" onblur="default_value_gallery_master('#ux_txt_buttons_border_style_color', '#ffffff')" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $image_browser_layout_general_buttons_border_style[2] ); ?>">
													</div>
													<i class="controls-description"><?php echo esc_attr( $gm_border_style_tooltip ); ?></i>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label">
														<?php echo esc_attr( $gm_buttons_font_style_title ); ?> :
														<span class="required" aria-required="true">* ( <?php echo esc_attr( $gm_premium_edition ); ?> )</span>
													</label>
													<div class="input-icon right">
														<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_buttons_font_style[]" id="ux_txt_buttons_font_size" placeholder="<?php echo esc_attr( $gm_font_size_placeholder ); ?>" value="<?php echo intval( $image_browser_layout_general_buttons_font_style[0] ); ?>" onblur="default_value_gallery_master('#ux_txt_buttons_font_size', 14);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);">
														<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_buttons_font_style[]" id="ux_txt_buttons_style_color" onblur="default_value_gallery_master('#ux_txt_buttons_style_color', '#ffffff');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $image_browser_layout_general_buttons_font_style[1] ); ?>">
													</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label">
														<?php echo esc_attr( $gm_buttons_font_family_title ); ?> :
														<span class="required" aria-required="true">* ( <?php echo esc_attr( $gm_premium_edition ); ?> )</span>
													</label>
													<div class="input-icon right">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-icon right">
													<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_thumbnails_button_padding_text[]" id="ux_txt_thumbnails_button_padding_top" placeholder="<?php echo esc_attr( $gm_top ); ?>" onblur="default_value_gallery_master('#ux_txt_thumbnails_button_padding_top', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_thumbnail_button_padding[0] ); ?>">
													<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_thumbnails_button_padding_text[]" id="ux_txt_thumbnails_button_padding_right" placeholder="<?php echo esc_attr( $gm_right ); ?>" onblur="default_value_gallery_master('#ux_txt_thumbnails_button_padding_right', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_thumbnail_button_padding[1] ); ?>">
													<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_thumbnails_button_padding_text[]" id="ux_txt_thumbnails_button_padding_bottom" placeholder="<?php echo esc_attr( $gm_bottom ); ?>" onblur="default_value_gallery_master('#ux_txt_thumbnails_button_padding_bottom', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_thumbnail_button_padding[2] ); ?>">
													<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_thumbnails_button_padding_text[]" id="ux_txt_thumbnails_button_padding_left" placeholder="<?php echo esc_attr( $gm_left ); ?>" onblur="default_value_gallery_master('#ux_txt_thumbnails_button_padding_left', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_thumbnail_button_padding[3] ); ?>">
												</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												...
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_gallery_description_font_style[]" id="ux_txt_gallery_description_font_color" onblur="default_value_gallery_master('#ux_txt_gallery_description_font_color', '#787D85');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $image_browser_layout_gallery_description_font_style[1] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_font_style_title_tooltip ); ?></i>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_title_font_style_image[]" id="ux_txt_title_font_size_image" placeholder="<?php echo esc_attr( $gm_font_size_placeholder ); ?>" onblur="default_value_gallery_master('#ux_txt_title_font_size_image', 14);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_font_style[0] ); ?>">
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_title_font_style_image[]" id="ux_txt_title_style_color_image" onblur="default_value_gallery_master('#ux_txt_title_style_color_image', '#787D85');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $image_browser_layout_thumbnail_title_font_style[1] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_font_style_title_tooltip ); ?></i>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text_image[]" id="ux_txt_title_margin_top_image" placeholder="<?php echo esc_attr( $gm_top ); ?>" onblur="default_value_gallery_master('#ux_txt_title_margin_top_image', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_margin[0] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text_image[]" id="ux_txt_title_margin_right_image" placeholder="<?php echo esc_attr( $gm_right ); ?>" onblur="default_value_gallery_master('#ux_txt_title_margin_right_image', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_margin[1] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text_image[]" id="ux_txt_title_margin_bottom_image" placeholder="<?php echo esc_attr( $gm_bottom ); ?>" onblur="default_value_gallery_master('#ux_txt_title_margin_bottom_image', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_margin[2] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_margin_text_image[]" id="ux_txt_title_margin_left_image" placeholder="<?php echo esc_attr( $gm_left ); ?>" onblur="default_value_gallery_master('#ux_txt_title_margin_left_image', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_margin[3] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_margin_gallery_title_tooltip ); ?></i>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text_image[]" id="ux_txt_title_padding_top_image" placeholder="<?php echo esc_attr( $gm_top ); ?>" onblur="default_value_gallery_master('#ux_txt_title_padding_top_image', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_padding[0] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text_image[]" id="ux_txt_title_padding_right_image" placeholder="<?php echo esc_attr( $gm_right ); ?>" onblur="default_value_gallery_master('#ux_txt_title_padding_right_image', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_padding[1] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text_image[]" id="ux_txt_title_padding_bottom_image" placeholder="<?php echo esc_attr( $gm_bottom ); ?>" onblur="default_value_gallery_master('#ux_txt_title_padding_bottom_image', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_padding[2] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_title_padding_text_image[]" id="ux_txt_title_padding_left_image" placeholder="<?php echo esc_attr( $gm_left ); ?>" onblur="default_value_gallery_master('#ux_txt_title_padding_left_image', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_title_padding[3] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_padding_gallery_title_tooltip ); ?></i>
										</div>
									</div>
								...
								<div class="tab-pane" id="thumbnail_description">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font_style_image[]" id="ux_txt_description_font_size_image" placeholder="<?php echo esc_attr( $gm_font_size_placeholder ); ?>" onblur="default_value_gallery_master('#ux_txt_description_font_size_image', 12);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_font_style[0] ); ?>">
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font_style_image[]" id="ux_txt_description_font_color_image" onblur="default_value_gallery_master('#ux_txt_description_font_color_image', '#787D85');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $image_browser_layout_thumbnail_description_font_style[1] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_font_style_title_tooltip ); ?></i>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_margin_image[]" id="ux_txt_description_margin_top_image" placeholder="<?php echo esc_attr( $gm_top ); ?>" onblur="default_value_gallery_master('#ux_txt_description_margin_top_image', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_margin[0] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_margin_image[]" id="ux_txt_description_margin_right_image" placeholder="<?php echo esc_attr( $gm_right ); ?>" onblur="default_value_gallery_master('#ux_txt_description_margin_right_image', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_margin[1] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_margin_image[]" id="ux_txt_description_margin_bottom_image" placeholder="<?php echo esc_attr( $gm_bottom ); ?>" onblur="default_value_gallery_master('#ux_txt_description_margin_bottom_image', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_margin[2] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_margin_image[]" id="ux_txt_description_margin_left_image" placeholder="<?php echo esc_attr( $gm_left ); ?>" onblur="default_value_gallery_master('#ux_txt_description_margin_left_image', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_margin[3] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_margin_gallery_title_tooltip ); ?></i>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_padding_image[]" id="ux_txt_description_padding_top_image" placeholder="<?php echo esc_attr( $gm_top ); ?>" onblur="default_value_gallery_master('#ux_txt_description_padding_top_image', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_padding[0] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_padding_image[]" id="ux_txt_description_padding_right_image" placeholder="<?php echo esc_attr( $gm_right ); ?>" onblur="default_value_gallery_master('#ux_txt_description_padding_right_image', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_padding[1] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_padding_image[]" id="ux_txt_description_padding_bottom_image" placeholder="<?php echo esc_attr( $gm_bottom ); ?>" onblur="default_value_gallery_master('#ux_txt_description_padding_bottom_image', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_padding[2] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_description_padding_image[]" id="ux_txt_description_padding_left_image" placeholder="<?php echo esc_attr( $gm_left ); ?>" onblur="default_value_gallery_master('#ux_txt_description_padding_left_image', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $image_browser_layout_thumbnail_description_padding[3] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_padding_gallery_title_tooltip ); ?></i>
										</div>
									</div>
