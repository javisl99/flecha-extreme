								...
								<div class="tab-pane active" id="general">
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-icon right">
													<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_and_transperancy[]" id="ux_txt_background_color" placeholder="<?php echo esc_attr( $gm_background_color ); ?>" onfocus="color_picker_gallery_master(this, this.value)"  value="<?php echo esc_attr( $masonry_background_color_and_transperancy[0] ); ?>">
													<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_and_transperancy[]" id="ux_txt_background_transperancy" maxlength="3" placeholder="<?php echo esc_attr( $gm_background_transparency ); ?>" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onchange="check_opacity_gallery_master(this);" onblur="default_value_gallery_master('#ux_txt_background_transperancy', 50);" value="<?php echo intval( $masonry_background_color_and_transperancy[1] ); ?>">
												</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-icon right">
													<input type="text" class="form-control input-width-25 input-inline" name="ux_txt_border_style[]" id="ux_txt_border_style_width" placeholder="<?php echo esc_attr( $gm_width_placeholder ); ?>" onblur="default_value_gallery_master('#ux_txt_border_style_width', '0');" value="<?php echo intval( $masonry_layout_general_border_style[0] ); ?>">
													...
													<input type="text" class="form-control input-normal input-inline" name="ux_txt_border_style[]" id="ux_txt_border_style_color" onfocus="color_picker_gallery_master(this, this.value)" onblur="default_value_gallery_master('#ux_txt_border_style_color', '#cccccc');" placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $masonry_layout_general_border_style[2] ); ?>">
												</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control" name="ux_txt_border_radius" id="ux_txt_border_radius" placeholder="<?php echo esc_attr( $gm_border_radius_title ); ?>"  maxlength="3" onblur="default_value_gallery_master('#ux_txt_border_radius', 0)" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo isset( $manage_masonry_data['masonry_layout_general_border_radius'] ) ? intval( $manage_masonry_data['masonry_layout_general_border_radius'] ) : 0; ?>">
											</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control" name="ux_txt_shadow_color" id="ux_txt_shadow_color" onblur="default_value_gallery_master('#ux_txt_shadow_color', '#000000');" placeholder="<?php echo esc_attr( $gm_shadow_color ); ?>" onfocus="color_picker_gallery_master(this, this.value)"  value="<?php echo isset( $manage_masonry_data['masonry_layout_general_shadow_color'] ) ? esc_attr( $manage_masonry_data['masonry_layout_general_shadow_color'] ) : '#000000'; ?>">
											</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control" name="ux_txt_transition_time" id="ux_txt_transition_time" placeholder="<?php echo esc_attr( $gm_transition_title ); ?>" onblur="default_value_gallery_master('#ux_txt_transition_time', 1)" maxlength="1" onkeypress="digits_with_dot_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo isset( $manage_masonry_data['masonry_layout_general_transition_time'] ) ? intval( $manage_masonry_data['masonry_layout_general_transition_time'] ) : 1; ?>">
											</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_top_text" placeholder="<?php echo esc_attr( $gm_top ); ?>" onblur="default_value_gallery_master('#ux_txt_masonry_padding_top_text', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $masonry_layout_general_padding[0] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_right_text" placeholder="<?php echo esc_attr( $gm_right ); ?>" onblur="default_value_gallery_master('#ux_txt_masonry_padding_right_text', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $masonry_layout_general_padding[1] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_bottom_text" placeholder="<?php echo esc_attr( $gm_bottom ); ?>" onblur="default_value_gallery_master('#ux_txt_masonry_padding_bottom_text', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $masonry_layout_general_padding[2] ); ?>">
												<input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_masonry_padding_text[]" id="ux_txt_masonry_padding_left_text" placeholder="<?php echo esc_attr( $gm_left ); ?>" onblur="default_value_gallery_master('#ux_txt_masonry_padding_left_text', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval( $masonry_layout_general_padding[3] ); ?>">
											</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												...
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_gallery_description_font_style[]" id="ux_txt_gallery_description_font_color" onblur="default_value_gallery_master('#ux_txt_gallery_description_font_color', '#787D85');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $masonry_layout_gallery_description_font_style[1] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_font_style_title_tooltip ); ?></i>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												...
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_title_font_style[]" id="ux_txt_title_style_color" onblur="default_value_gallery_master('#ux_txt_title_style_color', '#787D85');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $masonry_layout_thumbnail_title_font_style[1] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_font_style_title_tooltip ); ?></i>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-icon right">
												...
												<input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_description_font[]" id="ux_txt_description_font_color" onblur="default_value_gallery_master('#ux_txt_description_font_color', '#787D85');" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo esc_attr( $gm_color_placeholder ); ?>" value="<?php echo esc_attr( $masonry_layout_thumbnail_description_font_style[1] ); ?>">
											</div>
											<i class="controls-description"><?php echo esc_attr( $gm_font_style_title_tooltip ); ?></i>
										</div>
									</div>
